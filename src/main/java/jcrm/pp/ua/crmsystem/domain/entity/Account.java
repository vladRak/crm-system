...
import jcrm.pp.ua.crmsystem.domain.AbstractEntity;
...
public class Account extends AbstractEntity {
    ...
    @OneToMany(
            ...
            fetch = LAZY,
            mappedBy = "account")
    private List<BaseClientImplImpl> clients;
...
//            List<BaseClientImplImpl> clients, List<Lead> leads,
//            List<Task> tasks) {
...
//    }
    ...
    public void setClients(List<BaseClientImplImpl> clients) {
...
//    }
    ...
    public void addClient(BaseClientImplImpl client) {
        addClients(Arrays.asList(client));
    }

    public void addClients(List<BaseClientImplImpl> clients) {
        for (BaseClientImplImpl c : clients) {
            c.setAccount(this);
            this.clients.add(c);
        }
    }
...
//    }
    ...
    public void addClient(BaseClientImplImpl client, boolean add) {
