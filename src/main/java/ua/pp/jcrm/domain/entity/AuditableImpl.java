...
import ua.pp.jcrm.domain.util.IdGenerator;
...
public abstract class AuditableImpl<U> implements Auditable<U, String> {
    ...
    public boolean isNew() {
        return id != null && generatedId.equals(id);
    }

    public String toString() {
        return String.format("BaseEntity of type %s with id: %s", this.getClass().getName(), this.getId());
    }
